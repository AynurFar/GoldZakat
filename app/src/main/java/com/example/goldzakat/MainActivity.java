...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void calculateZakat() {
        try {
            ...
            if (weight < 0) {
                Toast.makeText(this, "Please enter a valid gold weight.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (keep.isChecked()) {
                if (weight < 85) {
                    Toast.makeText(this, "You are not eligible for Gold Zakat.", Toast.LENGTH_SHORT).show();
                    return;
                }
            ...
            String result;
            if (zakat <= 0) {
                result = "You have no Zakat to pay.";
            } else
            {
